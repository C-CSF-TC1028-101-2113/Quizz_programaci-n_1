...
**Nota:** raizcuadrada no existe, ¿cual es la funcion correcta que debes utilizar?. Hay una funcion que te provee Python para realizar un redondeo hasta una cantidad especifica de numeros decimales.
